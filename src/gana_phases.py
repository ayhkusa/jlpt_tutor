"""Common Japanese phrases for hiragana learning exercises."""

from __future__ import annotations

COMMON_JAPANESE_PHRASES: list[dict[str, str]] = [
    {
        "hiragana": "こんにちは",
        "romaji": "konnichiwa",
...
def get_phrase_exercises() -> list[dict[str, str]]:
    """Return a copy of the phrase list for exercise use."""
    return [dict(phrase) for phrase in COMMON_JAPANESE_PHRASES]
